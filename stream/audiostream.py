...
class AudioStream(MediaStream):
    ...
    def __init__(self, filename=None, codecLongName=None, codecTag=None, codecTagString=None, codecName=None, streamIndex=None, bitPerSample=None, sampleRate=None):
        """
            Constructor
            ...
            """
        super(AudioStream, self).__init__(filename, "audio", codecLongName, codecTag, codecTagString, codecName, streamIndex)
